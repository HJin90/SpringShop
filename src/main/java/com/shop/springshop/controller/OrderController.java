...
public class OrderController {
    ...
    public String orderHistoy(@PathVariable("page") Optional<Integer> page, Principal principal, Model model) {
    ...
    public @ResponseBody ResponseEntity cancelOrder(@PathVariable("orderId")Long orderId,Principal principal) {
        if(!orderService.validationOrder(orderId, principal.getName())) {
